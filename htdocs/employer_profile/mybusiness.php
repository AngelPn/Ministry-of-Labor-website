  ...
  <main class="hoc container clear"> 
    ...
    <div class="content three_quarter" id="stoixeia"> 
        ...
        <div id="comments">
          <div style='float: right;'>
            <form action="business_data.php">
              <input type='submit' name='submit' value='Τροποποίηση στοιχείων' style='background-color: #0D3476; color: #FFFFFF;'>
            </form>
          </div>
        </div>
      </div>
      ...
      <div class="scrollable" id="ergazomenoi">
        ...
        <!-- <div class="pagination" style="padding-left: 280px;">
          <a href="#">&laquo;</a>
          <a class="activep" href="#">1</a>
          <a href="#">&raquo;</a>
        </div> -->

      

      <div class="content member" id="adeies" style="margin-bottom: 10px;">
