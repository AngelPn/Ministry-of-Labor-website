    ...
    <?php
      if(isset($_SESSION['status_rantevou'])){
        if($_SESSION['status_rantevou'] == true){
            ...
            echo "<p style= 'text-align:center;'>Στοιχεία του ραντεβού:</p>";

            require_once "../authentication/config.php";

            $datetime = $_SESSION['rantevou_datetime'];
            unset($_SESSION['rantevou_datetime']);   

            // Create connection to get rantevou
            $sql = "SELECT datetime, text, name, phone FROM rantevou WHERE datetime = '$datetime' ";
            ...
            echo "<div id='comments'>
                    <div style='text-align:left;'>
                        &nbsp;
                        <input type='submit' name='submit' value='Ακύρωση ραντεβού' style='background-color: #FFFFFF; color: #0D3476;'>
                    </div>                    
                    <div style='text-align:center;'>
                      <form action='../index.php'>
                        <input type='submit' name='submit' value='Επιστροφή στην αρχική σελίδα' style='background-color: #0D3476; color: #FFFFFF;'>
                      </form>
                    </div>
                  </div>";
        } 
        ...
        if($_SESSION['status_adeies'] == true){
            ...
            <div style='text-align:center;'>
              <form action='../employer_profile/mybusiness.php'>
                <input type='submit' name='submit' value='Επιστροφή στην Επιχείρησή μου' style='background-color: #0D3476; color: #FFFFFF;'>
              </form>
            </div>
          </div>";
        }
        ...
        if($_SESSION['status_user_data'] == true){
            ...
            <div style='text-align:center;'>
              <form action='../employee_profile/myemployment.php'>
                <input type='submit' name='submit' value='Επιστροφή στην Εργασία μου' style='background-color: #0D3476; color: #FFFFFF;'>
              </form>
            </div>
          </div>";
        } 
