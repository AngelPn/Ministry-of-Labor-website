  ...
  <div id="topbar" class="hoc clear">
    <div class="fl_right"> 
      ...
      <ul class="nospace">
        ...
        <li><a href="epikinonia.php" title="Επικοινωνία">Επικοινωνία</a></li>
        <?php
        session_start();
...
<div class="wrapper row1">
  <header id="header" class="hoc clear">
    <div id="logo" class="fl_left"> 
      <!-- ################################################################################################ -->
      <a href="index.php"><img src="images/logo.png" alt="logo" style="height:75px;" ></a>
      <!-- ################################################################################################ -->
    </div>
      ...
      <!-- <section class="hoc container clear">  -->
        <!-- ################################################################################################ -->
          ...
          <ul class="nospace group prices">
            ...
            <!-- <li class="one_half">
              <article><i class="fas fa-building"></i>
                <h6 class="heading">Κρούσμα NEW σε εργασιακό περιβάλλον</h6>
                <p>Τι να κάνετε σε περίπτωση κρούσματος στο περιβάλλον εργασίας σας (για εργοδότες και εργαζόμενους)</p>
                <footer><a class="btn" href="pages/krousma.html">Περισσότερα</a></footer>
              </article>
            </li> -->
